    ...
    return (
        <main className="px-6 sm:px-10 md:px-16 lg:px-20 py-10 text-gray-900">
            ...
            <div className="text-4xl font-bold text-center mb-12">
                <p> FinSight: Financial Budgeting Tool </p>
                <div className="flex justify-center items-center gap-10 mt-5">
                    <a
                        className="text-base"
                        href={
                            "https://docs.google.com/document/d/1MCSTNE4kVr2HY54vND6QmzTICZthEUIK94PdElplr1Y/edit?tab=t.0"
                        }
                    >
                        <Google /> <p>Doc Link</p>
                    </a>
                    <a
                        className="text-base"
                        href="https://drive.google.com/file/d/1CbnEfKv1jYJvQhNi____O0Zfce5eakzx/view?usp=sharing"
                    >
                        <Movie /> <p>Demo Link</p>
                    </a>
                </div>
            ...
            <div className="flex items-center justify-between mb-10">
                <h2 className="text-2xl italic">Coding Project</h2>
